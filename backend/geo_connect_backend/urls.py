...
urlpatterns = [
    ...
    path("api/v1/admin/", include("apps.analytics.urls")),    # NEW
    path("api/v1/admin/", include("apps.settlement.urls")),   # NEW
    path("api/v1/admin/", include("apps.support.urls")),      # admin support endpoints
